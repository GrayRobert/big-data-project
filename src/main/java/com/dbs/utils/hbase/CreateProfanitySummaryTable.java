...
public class CreateProfanitySummaryTable {
    ...
    public static void run() {
        ...
        try {
            ...
            try {
                ...
                HTableDescriptor tableName = new HTableDescriptor(TableName.valueOf(Constants.HBASE_PROFANITY_SUMMARY_TABLE_NAME));
